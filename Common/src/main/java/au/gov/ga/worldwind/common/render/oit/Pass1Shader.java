...
/**
 * Pass 1 shader for the weighted average order independent transparency
 * algorithm.
 * 
 * @author Michael de Hoog (michael.dehoog@ga.gov.au)
 */
public class Pass1Shader extends Shader
{
	@Override
	...
	{
		return this.getClass().getResourceAsStream("wavg_init_vertex.glsl");
	}

	@Override
	protected InputStream getFragmentSource()
	{
		return this.getClass().getResourceAsStream("wavg_init_fragment.glsl");
	}
